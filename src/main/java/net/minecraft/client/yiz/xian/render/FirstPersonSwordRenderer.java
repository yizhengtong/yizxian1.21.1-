...
public final class FirstPersonSwordRenderer {
    ...
    /** 动画 D：挥砍4（5 帧，无空闲过渡，播完直接回待机）。 */
    private static final float[][] ANIM_D = {
        {154,  40,  133, -37.37f, -4.75f,-29.62f, 2.50f, 2.50f, 1.00f, 0.00f},  // KF1(1111)
        {-177,  46, -179, -23.37f,  8.25f,-29.62f, 2.50f, 2.50f, 1.00f, 0.25f},  // KF2(2222)
        {168,  86, -147,   4.88f, 21.00f,-29.62f, 2.81f, 2.08f, 1.00f, 0.50f},  // KF3(3333)
        { 96,  57,  -60,  17.13f, 27.75f,-25.12f, 2.50f, 2.50f, 1.00f, 0.75f},  // KF4(4444)
        {127,  48, -167, -30.12f, -3.75f,-35.87f, 2.50f, 2.50f, 1.00f, 1.00f},  // KF5(5555) → 回待机
    };
