...
public final class FirstPersonSwordRenderer {
    ...
    private static final float[][] ANIM_C = {
        ...
        { 31,  95,  -69,  -9.00f,  1.50f,-24.50f, 1.70f, 1.70f, 0.44f, 1.00f},  // KF4(555) → 播完直接跳待机
    };

    /** 动画 D：挥砍4（1111~666.bbmodel，6 帧正向播完直接回待机）。 */
    private static final float[][] ANIM_D = {
        {-52, -69, -180, -22.87f, -1.30f, -1.12f, 1.00f, 1.00f, 0.44f, 0.00f},  // KF0 起手(1111)
        {-88,   1,  137, -14.62f, -4.25f,-17.62f, 2.10f, 2.10f, 0.44f, 0.17f},  // KF1(2222)
        {107,  72,  -52,   7.63f, 26.00f,-32.37f, 2.27f, 2.27f, 0.44f, 0.33f},  // KF2(3333)
        {133,  70, -115,  -5.12f, 16.50f,-18.62f, 2.27f, 2.27f, 0.44f, 0.55f},  // KF3(4444)
        {144,  45, -178, -19.37f,  5.25f,-18.62f, 2.27f, 2.27f, 0.44f, 0.72f},  // KF4(5555)
        {-99,   6,   69, -23.25f, -0.75f,-18.75f, 1.70f, 1.70f, 0.44f, 1.00f},  // KF5(666) → 播完回待机
    };

    /** 动画数组：A=挥砍1, B=挥砍2, C=挥砍3, D=挥砍4。 */
    private static final float[][][] ANIMS = { ANIM_A, ANIM_B, ANIM_C, ANIM_D };
