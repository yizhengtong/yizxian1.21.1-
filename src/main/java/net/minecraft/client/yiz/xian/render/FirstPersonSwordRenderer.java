...
public final class FirstPersonSwordRenderer {
    ...
    /** 动画 D：挥砍4（4 帧全连贯，KF1 起手即空闲姿态）。 */
    private static final float[][] ANIM_D = {
        {-52, -69, -180, -22.87f, -1.30f, -1.12f, 1.00f, 1.00f, 0.44f, 0.00f},  // KF1 起手(1111)
        {-53, -30, -177, -37.37f, -4.75f,-29.62f, 2.50f, 2.50f, 1.00f, 0.33f},  // KF2(2222)
