...
public final class FirstPersonSwordRenderer {
    ...
    /** 动画 C：挥砍3（111~666.bbmodel，6 帧正向专用收刀）。 */
    private static final float[][] ANIM_C = {
        {-52, -69, -180, -22.87f, -1.30f, -1.12f, 1.00f, 1.00f, 0.44f, 0.00f},  // KF0 起手(111)
        {-37, -35,  180, -22.62f,  4.95f, -7.62f, 1.00f, 1.00f, 0.60f, 0.20f},  // KF1(222)
        {-52, -28,  123, -18.12f, 12.70f, -7.62f, 1.00f, 1.00f, 0.60f, 0.40f},  // KF2(333)
        {  0,  91,   57,  -8.62f, 34.50f,-19.12f, 1.70f, 1.70f, 0.44f, 0.60f},  // KF3(444)
        { 31,  95,  -69,  -9.00f,  1.50f,-24.50f, 1.70f, 1.70f, 0.44f, 0.82f},  // KF4(555)
        {-99,   6,   69, -23.25f, -0.75f,-18.75f, 1.70f, 1.70f, 0.44f, 1.00f},  // KF5 收刀(666)
    };
