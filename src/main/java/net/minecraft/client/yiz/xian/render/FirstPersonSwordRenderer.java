...
public final class FirstPersonSwordRenderer {
    ...
    private static final float[][] ANIM_A = {
        {-52, -26, 162, -20.62f, 1.70f,  -1.12f,  1, 1, 0.44f, 0.00f},  // KF1 拔刀起手
        {-66,  -1,  80, -25.75f, 4.45f, -13.75f,  1, 1, 0.44f, 0.35f},  // KF2
        {-66,  -1,  50,  -8.75f, 4.45f, -16.00f,  1, 1, 0.44f, 0.65f},  // KF3
        {-66,  -1,   6,  11.25f, 4.45f, -16.00f,  1, 1, 0.44f, 1.00f},  // KF4 挥砍终点
    };
