...
public final class FirstPersonSwordRenderer {
    ...
    /** 动画 D：挥砍4（1→2连贯, 2→3跳跃, 3→4连贯）。 */
    private static final float[][] ANIM_D = {
        {-52, -69, -180, -22.87f, -1.30f, -1.12f, 1.00f, 1.00f, 0.44f, 0.00f},  // KF1(1111)
        {-53, -30, -177, -37.37f, -4.75f,-29.62f, 2.50f, 2.50f, 1.00f, 0.50f},  // KF2(2222) → 跳
        { 96,  57,  -60,  17.13f, 27.75f,-25.12f, 2.50f, 2.50f, 1.00f, 0.50f},  // KF3(3333) → 连贯
