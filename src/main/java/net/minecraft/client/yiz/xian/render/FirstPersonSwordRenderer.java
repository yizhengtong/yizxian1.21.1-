...
public final class FirstPersonSwordRenderer {
    ...
    /** 动画 D：挥砍4（4 帧纯攻击，无空闲帧无过渡，播完直接回待机）。 */
    private static final float[][] ANIM_D = {
        {-53, -30, -177, -37.37f, -4.75f,-29.62f, 2.50f, 2.50f, 1.00f, 0.00f},  // KF1(1111)
        {-58, -40,  158, -23.37f, -0.50f,-29.62f, 2.50f, 2.50f, 1.00f, 0.33f},  // KF2(2222)
        { 96,  57,  -60,  17.13f, 27.75f,-25.12f, 2.50f, 2.50f, 1.00f, 0.66f},  // KF3(3333)
        {135,  51,  147, -38.62f, -8.25f,-35.87f, 2.50f, 2.50f, 1.00f, 1.00f},  // KF4(4444) → 回待机
    };
