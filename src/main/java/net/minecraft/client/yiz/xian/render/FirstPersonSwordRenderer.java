...
public final class FirstPersonSwordRenderer {
    ...
    /** 动画 D：挥砍4（纯 3 帧，无 KF0 无过渡，播完直接回待机）。 */
    private static final float[][] ANIM_D = {
        { 96,  57,  -60,  17.13f, 27.75f,-25.12f, 2.50f, 2.50f, 1.00f, 0.00f},  // KF1(1111)
        {107,  48, -146,  -5.12f,  9.00f,-32.87f, 2.27f, 2.27f, 0.44f, 0.50f},  // KF2(2222)
        {127,  48, -167, -30.12f, -3.75f,-35.87f, 2.50f, 2.50f, 1.00f, 1.00f},  // KF3(3333) → 回待机
    };
