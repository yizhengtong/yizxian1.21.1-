...
public final class FirstPersonSwordRenderer {
    ...
    /** 动画 D：挥砍4（3 帧正向播完直接回待机）。 */
    private static final float[][] ANIM_D = {
        {-52, -69, -180, -22.87f, -1.30f, -1.12f, 1.00f, 1.00f, 0.44f, 0.00f},  // KF0 起手(1111)
        {107,  72,  -52,   7.63f, 26.00f,-32.37f, 2.27f, 2.27f, 0.44f, 0.50f},  // KF1(2222)
        {133,  70, -115,  -5.12f, 16.50f,-18.62f, 2.27f, 2.27f, 0.44f, 1.00f},  // KF2(3333) → 播完回待机
    };
