...
public final class FirstPersonSwordRenderer {
    ...
    /** 动画 D：挥砍4（KF1→KF2连贯, KF2→KF3跳跃, KF3→KF4连贯）。 */
    private static final float[][] ANIM_D = {
        {-53, -30, -177, -37.37f, -4.75f,-29.62f, 2.50f, 2.50f, 1.00f, 0.00f},  // KF1(1111)
        {-58, -40,  158, -23.37f, -0.50f,-29.62f, 2.50f, 2.50f, 1.00f, 0.50f},  // KF2(2222) 连贯终点
        { 96,  57,  -60,  17.13f, 27.75f,-25.12f, 2.50f, 2.50f, 1.00f, 0.50f},  // KF3(3333) 跳跃起点
        {135,  51,  147, -38.62f, -8.25f,-35.87f, 2.50f, 2.50f, 1.00f, 1.00f},  // KF4(4444) 连贯终点 → 回待机
    };
